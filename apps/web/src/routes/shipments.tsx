    ...
    <AppLayout>
      ...
      <Card>
        <CardContent className="p-0">
          {isLoading ? (
            <div className="flex items-center justify-center py-12 text-[--color-muted-foreground]">
              Cargando...
            </div>
          ) : shipments.length === 0 ? (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[--color-border]">
                  ...
                  <th className="px-4 py-3 text-left font-medium text-[--color-muted-foreground]">Carga</th>
                ...
                {shipments.map((s) => {
                  ...
                  return (
                    <tr key={s.id} className="border-b border-[--color-border] last:border-0 hover:bg-[--color-muted]/50">
                      <td className="px-4 py-3 font-mono font-semibold">{s.folio}</td>
                      ...
                      <td className="px-4 py-3 text-[--color-muted-foreground]">{s.cargo.description}</td>
                      <td className="px-4 py-3">
